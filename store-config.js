window.NovaCartStore = {
  ...
  googleMapsSearch: "https://www.google.com/maps/search/?api=1&query=%C4%90.%20S%E1%BB%91%203%2C%20Trung%20M%E1%BB%B9%20T%C3%A2y%2C%20H%E1%BB%93%20Ch%C3%AD%20Minh"
};
...
(function () {
  function applyStoreContact() {
    ...
    phoneEls.forEach((el) => {
      if (el) el.textContent = store.phone || "+84 961xxx-xxx";
    });
    ...
    if (mapLink) {
      mapLink.href = store.googleMapsSearch || "https://www.google.com/maps/search/?api=1&query=%C4%90.%20S%E1%BB%91%203%2C%20Trung%20M%E1%BB%B9%20T%C3%A2y%2C%20H%E1%BB%93%20Ch%C3%AD%20Minh";
    }
  }
